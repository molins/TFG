...
\begin{rf0}
	...
	\item Visualización de resultados.
		\begin{rf0*}
			...
			\item Cuando una pregunta tenga una cadena de feedback asociada, se mostrará a los alumnos después de que respondan, junto con si la respuesta ha sido correcta o no.
