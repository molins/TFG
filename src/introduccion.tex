...
Durante el verano de 2013 se empezaron a definir los primeros modelos de usuario y de adaptación, que se plasmarían en un primer prototipo del sistema desarrollado para el curso 13/14 que se utilizó en una asignatura del Grado de Historia.
...
Esta investigación ha sido apoyada por la Convocatoria de Proyectos de Innovación Docente de la Universidad Autónoma de Madrid durante los cursos 2012/2013, 2013/2014, y 2014/2015, además de una Beca de Colaboración del Ministerio de Educación, Cultura y Deporte para el curso 2014/2015.
...
\begin{itemize}
	...
	\item Crear un modelo de datos que abstraiga las entidades y relaciones más importantes en una evaluación, que permita guardar toda la información posible para realizar análisis posteriores.
	\item Diseñar una arquitectura para el sistema que sea lo suficientemente flexible para permitir incorporar de forma sencilla los nuevos modelos que se van a ir desarrollando conforme avance la investigación.
\end{itemize}
...
En el siguiente capítulo, sobre el estado del arte, se presenta un repaso a la historia de los cuestionarios adaptativos por ordenador, además de una introducción a las características de los sistemas que a día de hoy están siendo desarrollados. 
...
El siguiente capítulo expone las conclusiones del trabajo. Por último, se detallan los retos que se pretenden tratar en trabajos futuros, seguidos de la bibliografía y una serie de apéndices. % TODO: Detallar los apéndices.
